...
const BooksCard = ({ book, isFavoriteHandel }) => {


    const { id, title, author, price, rating, isFavorite, image } = book

    // console.log(isFavorite, id);
    let ratingArray = [];

    function makingRatingArray() {
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-1">
                            {
                                ratingArray.map((num) => <img
                                    key={num} src="./assets/star.svg" />)
                            }
                    ...
                    <div className="flex items-center gap-3 text-xs lg:text-sm">
...

                        {
                            ...
                            isFavorite ? <button
                                ...
                                onClick={() => isFavoriteHandel(id, !isFavorite)}
                            >
                                <svg
                                    width="16"
                                    height="14"
